...
while True:
    ...
    if opcao == "1":
        ...
        usuario = input("Digite o nome do usuário que vai cadastrar a conta corrente: ")
        banco.selecionar_usuario(usuario)
        if banco.conta_atual:
            banco.criar_conta_corrente(banco.conta_atual)
        else:
            print("Erro: Usuário não encontrado.")
    elif opcao == "3":
